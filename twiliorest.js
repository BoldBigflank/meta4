...
exports.updateCall = function(callSid, url){
    var postData = "Url=" + url + "&Method=Post";
	var options = {
        host: API_SERVER,
        port: 443,
        path: '/' + API_VERSION +"/Accounts/" + accountSid + "/Calls/" + callSid,
        method: 'POST',
...
exports.sendTwiml = function(callSid, path){
